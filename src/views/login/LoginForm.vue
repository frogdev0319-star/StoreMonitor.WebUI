<template>
    <el-row class="login-container" :style="{'min-height':varyWindowHeight}">
        ...
        :style="{'min-height':varyWindowHeight}">
            ...
            <div class="model">
                ...
                <div class="title-content">
                    <img :src="picSrc1" alt="pic1" id="img1"/>
                    <span class="pic-info">{{picInfox}}</span>
                    <span class="pic-info">{{picInfoy}}</span>
                    <img :src="picSrc2" alt="pic2" id="img2"/>
                </div>
            </div>
            <!--图片轮播区域-->
            <div id="list" :style="{'width':divWidth,'left':divLeft,'height':varyWindowHeight}">
                <img v-for="(item,index) in imgList" :key="index" :style="{'width':varyWindowWidth,'height':varyWindowHeight}"
        ...
        <el-col :span="8" class="rside" :style="{'min-height':varyWindowHeight}">
            ...
            <el-form-item prop="password">
                <span class="svg-container">
                    <i class="iconfont icon-suo icons"></i>
                </span>
                <el-input
                    class="el-login-input"
                    :type="passwordType"
                    ...
                    <span class="show-pwd" @click="showPwd">
                        <i class="iconfont icons" :class="passwordType=='password'?'icon-xianshi':'icon-yincangcopy'"></i>
                    </span>
            </el-form-item>
            ...
            <div class="el-il8">
                <el-select size="small" v-model="curIl8" class="el-il8List">
                    <el-option
            ...
            <el-button :loading="loading" type="primary"  class="login-btn" size="small"
    ...
    name:'Login',
     data(){
        ...
        return{
            ...
            logoSrc:'./static/img/imgLogin/logo.png',
            imgList:[
                {
                    name:'04pic',
                    src:'./static/img/imgLogin/01pic_left.jpg',
                    alt:'背景图片04',
                },
                {
                    name:'01pic',
            ...
            picInfoy:'实时掌握门店动态',
            imgSrc:{
                androidSrc:'./static/img/imgLogin/Android_pic.png',
                iosSrc:'./static/img/imgLogin/IOS_pic.png'
            },
            curIl8:'zh-ch',
            il8List:[
                {
