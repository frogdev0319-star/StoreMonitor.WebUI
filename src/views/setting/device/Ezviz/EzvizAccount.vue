      ...
      <div class="form-slot">
        <el-form
          ...
          <div v-else>
            <el-row>
              <el-col :span="24">
                <el-form-item class="ezviz-account-form"
                              :label="`${this.$t('deviceView.mobilePhone')}`"
                              :error="errorAccount" prop="ezvizAccount">
            ...
            <el-form-item :label="$t('deviceView.developerService')" required>
              <div class="account-list">
                <el-form
                  ...
                  <el-form-item label="AppSecret" prop="appSecret" :error="errorMsg">
                  ...
                  <el-form-item
                    ...
                    <span v-if="validateResult" class="validate-text" style="margin-top:-10px;">{{ validateResult }}</span>
                  </el-form-item>
                </el-form>
              </div>
            </el-form-item>
...
export default {
  ...
  computed: {
    ...
    appKey() {
      return this.ezvizAccountInfo.appKey;
    },
    appSecret() {
      return this.ezvizAccountInfo.appSecret
    }
  },
  ...
  methods: {
    ...
    async getAccessTokenFromEzviz() {
      ...
      ezvizRESTful.getAccessToken(params).then(result => {
        ...
        if (code !== '200') {
          this.validateResult = self.$t('deviceView.validateFailed');
          this.isAccessTokenValid = false;
          switch (code) {
            case '10005': {
          ...
          this.validateResult = self.$t('deviceView.validateSucc');
          this.isAccessTokenValid = true;
