  ...
  <div class="setting-container">
    <div class="basic-info">
      ...
      <div class="basic-information">
        <el-form ref="infoForm" :model="infoForm" :rules="rules" label-position="left" label-width="120px"
                 class="infoForm">
          ...
          <el-form-item :label="$t('titleView.comment')" prop="comment" class="comment-class">
            ...
            <el-input v-model="infoForm.comment" :autosize="{minRows: 2, maxRows: 4}" style="width: 100%;"
                      type="textarea" class="role-comment" @input="commentChange" @blur="notShowInputRuleTips"/>
          ...
          <div v-for="(item,index) in roleNameList" v-show="item.disabled === false" :key="index" class="role-group">
            ...
            <div class="role-content">
              <div v-for="(_item,_index) in item.children"
                   ...
                   :class="lang === 'en'? 'en-role-detail': 'role-detail'" :key="_index">
  ...
  export default {
    ...
    methods: {
      ...
      getRequiredAuthority() {
        ...
        let self = this;
        let roleId = self.infoForm.roleId;
        PermissionHelper.setData(self.authorityInfoLists[roleId - 1].requiredAuth);
        let length = self.authorityInfoLists[roleId - 1].requiredAuth.length;
