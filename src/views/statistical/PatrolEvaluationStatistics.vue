    ...
    <el-row class="statistics-container">
      <el-col :span="24" class="statistics-header">
        <el-col :span="24" class="header-details">
          ...
          <el-select v-model="curCountry"  :placeholder="generateReportLang('country')" size="mini" class="el-province" @change="changeCountry" @clear="clearCountry">
    ...
    methods:{
      ...
      async export2Excel() {
        ...
        require.ensure([], async() => {
          ...
          const filterVal = ['region','cycleOfInspect','numOfReport','numOfQualified','numOfImproved','numOfDangerous','qualifiedRatePer','averageScore']; // 导出的表头字段名
          let self=this;
          let size= self.totalRegion;
          let params = {};
          params.beginTs = self.params.beginTs;
