  ...
  <div class="el-overview-content">
    ...
    <div class="el-overview">
      ...
      <el-row class="second-row">
        <el-col class="status-list" :span="isEnSpan? 7: 6">
          <div class="status-title">
            {{$t('overview.eventStatus')}}
          </div>
          <div class="pct-content">
            <div class="pct-panel">
              <v-chart :auto-resize='true' :options="eventStatusOptions" class="chart-content" ref="eventStatusRef"></v-chart>
            </div>
            <div class="pct-nums">
          ...
          <div class="store-status-panel"  >
            ...
            <div class="store-panel">
              <div class="store-list">
                ...
                <el-select v-model="rankType" placeholder="选择排序类型" style="width: 200px" size="mini" @change="changeRankType">
                  <el-option
              ...
              <div class="status-content">
                <v-chart  :options="storeStatusOptions"  class="result-content" :auto-resize='true' ref="storeStatusRef"/>
              </div>
            </div>
          </div>
        </el-col>
