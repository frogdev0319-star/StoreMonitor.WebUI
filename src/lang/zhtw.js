export default {
  ...
  "remotePatrol": {
    ...
    "code": "地點代碼",
    "coment": "請輸入處理評論文字",
    "comentRuletip": "最多可輸入1000個字元",
    "comentRuletip_suggest": "最多可輸入1000個字元",
    "commentDetail": "評論詳情：",
    "confirm": "確認",
    ...
    "requiredValid": "巡檢表中尚有必填項目，請繼續完成巡檢。",
    "score": "得分",
    "scoreU": "單位：個",
    "scoreUnit": "評分：",
    "scorecount": "分",
    ...
    "maximumTotalAttach_120": "全表最多允許上傳120個附件",
    "maximumTotalAttach_500": "全表最多允許上傳 500個附件",
    "totalOf": "巡檢報告共有",
    "numReports": "筆",
  ...
  "insSettingView": {
    ...
    "tHeaderF": "低於*分，須地點負責人處理（選填，-50~滿分）",
  ...
  "audit": {
    "auditStatus": {
      ...
      "open": "開啟",
      "autoApprove": "自動簽核",
      "autoApproveDays": "自動簽核天數",
      "most7Days": "自動簽核天數最多為七天。",
    },
    "sendAudit": {
      "all": "全部",
      "processing": "進行中",
  ...
  "generalSetting": {
    "save": "保存",
    "timeoutReminder": "超時提醒",
    "eventTimeoutReminder": "事件超時提醒",
    "moreThanDays": "超過天數",
    "daysOfStay": "停留天數",
    "reminderTime": "提醒時間",
    "signatureTimeoutReminder": "簽核超時提醒",
    "reports": "巡檢報告",
  ...
  "downloadManagement": {
    ...
    "ts": "匯出時間",
    "all": "全部",
    "inspectReport": "巡檢管理-巡檢報告",
    "eventMgn": "事件管理",
    "patrolEvaluation": "統計分析-巡檢考評統計",
    ...
    "requestType_6001": "地點事件",
    "requestType_6002": "事件佔比",
    "requestType_6003": "事件涉及地點",
