...
export default {
  ...
  remotePatrol:{
    ...
    eventNameRuletip:'最多可輸入50個字符',
    clear: '清除',
    cancel: '取 消',
    coment: '請輸入處理評論文字',
    comentRuletip:'最多可輸入200個字符',
    scoreUnit: '評分：',
    ignored: '已忽略',
    ignoreds: '不适用项',
    noItems: '暫無巡檢項！',
  ...
  insSettingView:{
    ...
    SchdRemoteLength:'远程巡检排程最多可创建十个',
    SchdOnsiteLength:'现场巡检排程最多可创建十个',
    ...
    excelLongCategory: '巡檢類別長度不可超過30個字符！',
    excelIllegalCategory: '存在“@#￥%^&*”外的非法字符！',
    excelEmpty: '巡檢類別與巡檢項不能為空！',
    excelLongItem: '巡檢項長度不可超過100個字符！',
    excelIllegalDes: '巡檢項目詳細說明不可超過300個字符！',
    deleteItem: '刪除巡檢項',
    setItem: '巡檢項設置',
    confirmDelete: '確認刪除',
    ...
    addCategory: '添加巡檢類別',
    enterName: '輸入巡檢類別名稱',
    enterNameRuletip:'最多可輸入30個字符',
    addInsItem: '新增巡檢項',
    deleteInsItem: '刪除巡檢項',
    description: '巡檢項需求描述',
    descriptionRuletip:'最多可輸入300個字符',
    titleEmpty: '類別名稱不能為空！',
  ...
  deviceView:{
    ...
    addNvr: '添加NVR',
    NvrnameRuletip:'最多可輸入20個字符',
    validateRuletip:'最多可輸入10個字符',
