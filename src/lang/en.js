export default {
  ...
  insSettingView: {
    ruleInspect: 'Rule setting', // Sprint11
    ...
    tHeaderF: 'Anomaly Events-Score Threshold（Optional，1~Total Score）',
    ...
    excelPassFailScoreType: 'Total Score: Optional, Integer, 1~50points',
