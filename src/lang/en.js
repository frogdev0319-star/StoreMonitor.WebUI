export default {
  ...
  route: {
    ...
    patrolShop: 'Patrol Management/ Daily Patrol',
    patrolPlan: 'Patrol Task',
    ...
    supervisorStat: 'Supervisory Work Statistics自定义需确认',
    customers: 'Customers',
  ...
  overview:{
    ...
    'patrolStatus': 'Regional Patrol Status',
    'danger': 'Dangerous',
    'improve' : 'To Be Improved',
    'pass': 'Qualified',
    'excellent' : 'Excellent',
    'worstRegion': 'Worst Region',
    'bestRegion': 'Best Region',
    'patrolRanking': 'Patrol Completion Rankings',
    'worstPatrol' : 'Worst Patrol Completion TOP5',
    'bestPatrol' : 'Best Patrol Completion TOP5',
    ...
    inscheduleNum: 'Patrol As Planned',
    unscheduleNum: 'Unplanned Patrol',
    completeRate: 'Completion Rate of Patrol',
    detail: 'Patrol Details',
    patrolExecution: 'Inspection of Patrol',
    patrolDate: 'Patrol Date',
    patrolMethod: 'Patrol Method',
    missionValidity: 'Task Deadline',
    inspectedStores: 'Patrolled Store',
    uninspectedStores: 'Unpatrolled Store',
  ...
  remotePatrol:{
    ...
    allIgnored: 'All inspection items are ignored, Please re-evaluate it.',
  ...
  storeMonitor:{
    ...
    notBindCamera: 'Hasn\'t binded with any cameras yet.',
  ...
  insSettingView:{
    ...
    group: 'groups',
    item: 'items',
    relationDuty:'关联职务自定义需确认',
    isExportPDF:'正在导出PDF',
    Inspector:'请选择巡检人自定义需确认',
    inspectName: 'Name',
    ...
    RemoteLength:'远程巡检表最多可导入十个自定义需确认',
    OnsiteLength:'现场巡检表最多可导入十个自定义需确认',
    SchdRemoteLength:'远程巡检排程最多可创建十个自定义需确认',
    SchdOnsiteLength:'现场巡检排程最多可创建十个自定义需确认',
    deletePatrolList:'当前没有可删除的巡检表自定义需确认',
    selectPost:'请选择关联职务自定义需确认',
    ...
    confirmDelData:'确认删除当前巡检表?自定义需确认',
    please: 'Please ',
  ...
  deviceView:{
    ...
    comment: 'Note',
    mobilePhone: 'Account (cell-phone number)',
    ...
    enterCorrentAccount: 'Please enter correct Ezviz account (cell-phone number)',
  ...
  scheduleView:{
    ...
    scheduleTitle:'请选择巡检类型&巡检表，设置对应排程自定义需确认',
    delete: 'Delete',
    details:'Details',
