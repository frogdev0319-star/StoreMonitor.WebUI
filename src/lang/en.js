export default {
  ...
  overview:{
    'date': 'Date',
    'dataRangeTips': '* Date range: 7 ~ 365 days',
    'totalStore': 'Total stores:',
    'totalUnit': '',
    'kpiIndex': 'KPIs',
    'totalPatrol': 'Patrol number',
    'advPatrolCycle': 'Average Patrol cycle',
    'patrolStatus': 'Regional patrol statistics',
    'danger': 'Dangerous',
    'improve' : 'Improve',
    'pass': 'Pass',
    'excellent' : 'Excellent',
    ...
    'passRate' : 'Pass rate ',
    'avgPatrlCycle' : 'Average Patrol cycle and Qualified rate in each region',
  ...
  deviceView:{
    ...
    appKeyFrozen: 'AppKey blocked',
    mismatchInfo: 'AppKey does not match Secret',
    enterCorrentAccount: 'Please enter correct account (cell-phone number)',
    accountExist: 'Account existing',
    enterDeveloperKey: 'Please enter developer key',
    enterAccountName: 'Nickname consists of 1~20 Chinese characters, letters or numbers',
