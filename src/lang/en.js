export default {
  ...
  overview:{
    ...
    'excellentMore' : 'Excellent Ratio≥60%',
    'excellentLess': 'Excellent Ratio＜60%',
    'noData': 'No Data',
    'day' : 'Day',
    'cycle' : 'Cycle',
  ...
  insSettingView:{
    ...
    excelLongCategory: 'Category name may not be over 30 characters, please check!',
    excelIllegalCategory: 'Category name contains illegal strings, please check!',
    excelEmpty: 'Item title may not be empty, please check!',
    excelLongItem: 'Item title name may not be over 100 characters, please check!',
    excelIllegalStr: 'Item title name contains illegal strings, please check!',
    excelIllegalDes: 'Description of item title name may not be over 300 characters, please check!',
