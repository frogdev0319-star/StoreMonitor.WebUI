...
export default {
  ...
  'insSettingView': {
    ...
    'addCategory': 'インスペクションカテゴリを追加',
    'enterName': 'カテゴリネームを入力してください',
    'addInsItem': 'インスペクションアイテムの追加',
    'deleteInsItem': 'インスペクションアイテムデリート',
