export default{
  ...
  "remotePatrol":{
    ...
    "week":{
      ...
      "maximumTotalAttach_150":"全表最多允许上传 500 个附件",
      "totalOf":"巡检报告共有",
      "numReports":"笔",
  ...
  "audit":{
    ...
    "createinspect":{
        ...
        "formType":"表單類型",
        "otherSettings":"其他設定",
        "ignoredItems":"忽略項視同得分",
        "SignFirst":"先簽到，再巡檢",
        "ShowAreaScoring":"顯示區域計分(僅支援網頁板)",
        "categoryScoring":"顯示巡檢類別計分",
        "permissionSettings":"權限設定",
        "PositionAuthority":"職務權限",
        "bindAllLocations":"綁定至所有地點",
        "PassRateScoringItems":"合格率評分項",
        "ScoringItems":"合格率評分項",
        "additionalRatingItems":"附加評分項",
        "secondLevelForm":"二階層表單",
        "threeLevelForm":"三階層表單",
        "noRepeat":"巡檢表名稱名稱不可重複",
        "startScoreNoEmpty":"扣分起始分數不可為空",
        "hiNoEmpty":"考評總分範圍最低分數不可為空",
        "lowNoEmpty":"考評總分範圍最高分數不可為空",
    },
    "deleteReport":{
