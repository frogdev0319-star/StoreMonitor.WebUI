...
export default {
  ...
  'insSettingView': {
    ...
    'sheetscore': '巡检评分项',
    'sheetother': '附加评分项',
    'notAllowAdd': ' [Pass-Failed] 和 [Others]Tab无法组成有效的巡检表，不允许新增！',
    'notallowdeletetips': '存在无效的巡检表Tab组合，不允许删除！',
    ...
    'excelFullScoreType': '项目总分值必填，取值范围为0~50的整数',
    'excelMinScoreType': '巡检项最低分值选填，取值范围为-50~项目总分值的整数',
