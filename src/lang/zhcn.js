export default {
  "route": {
    ...
    "storeMonitor": "现场监控",
    "storeSubEvent": "提交事件",
    "storeViuAccountDeviceSetting": "iService账号设备配置",
    "submitEvent": "巡检提交事件",
    "successSubmit": "提交成功",
    "supervisorStat": "巡检效率统计",
    "systemSetting": "系统设定",
    "title": "WISE-iQM",
    "titleManage": "职务管理",
    "titleSetting": "职务设置",
    ...
    "onsitePatrol": "现场巡检",
    "patrolPersonStat": "巡检人员统计",
    "patrolCompareStat": "巡检同比分析",
    "supervisorCalStat": "巡检考评统计",
    "patrolItemStat": "巡检项统计",
    "singleStoreStat": "单点分析",
    "workflowManage": "流程设计",
    "createWorkflow": "新增流程",
    ...
    "MysterioSetting": "地点权限设定",
    "InceptionSchedule": "巡检排程",
    "ScheduleSetting": "排程设定",
    "ScheduleHistory": "排程纪录",
    "PersonalSchedule": "个人排程",
    "CreateSchedule": "建立排程",
    "ModifySchedule": "编辑排程",
    "schedulePersonalCreate": "巡检排程｜个人排程",
  ...
  "overview": {
    ...
    "emptyStoreList": "地点列表为空，请重新筛选数据",
    "endDate": "结束日期",
    "eventGraph": "事件解决趋势图",
    "eventHading": "各地点事件处理情况",
    "eventList": "事件列表",
    "eventSource": "事件来源",
    "eventStatus": "事件处理状态",
    "eventTrends": "各地点事件态势分析",
    "everydays": "每",
    "excellent": "优秀",
    "excellentLess": "合格＜60%",
    "excellentMore": "合格≥60%",
    ...
    "good": "优良",
    "goodRate": "良好率",
    "htmltopdfA": "巡检考评统计PDF",
    "htmltopdfB": "巡检项统计PDF",
    "htmltopdfC": "巡检效率统计PDF",
    "htmltopdfD": "事件处理统计PDF",
    "ignored": "不适用",
    "improve": "待改善",
    "inscheduleNum": "按计划巡检次数",
    "inspectedStores": "已巡检地点",
    ...
    "patrolCate": "巡检项类别",
    "patrolDate": "巡检日期",
    "patrolExecution": "巡检执行情况",
    "patrolList": "巡检KPI列表",
    "patrolLists": "巡检表",
    "patrolMethod": "巡检方式",
    "patrolPlan": "巡检计划",
    "patrolRanking": "巡检任务完成率排名",
    "patrolStatus": "各区域工作地点巡检情况",
    "patrolStore": "巡检地点",
    "patrolType": "巡检表类型",
    "pending": "待处理",
    "pendingEvent": "待处理事件数",
    ...
    "totaFive": "事件总数量TOP5",
    "totalPatrol": "巡检总数",
    "totalStore": "地点总数：{storeNum}個",
    "uninspectedStores": "未巡检地点",
    "unscheduleNum": "计划外巡检次数",
    "user": "人员",
    "visitor": "拜访对象",
  ...
  "remotePatrol": {
    ...
    "confirmSum": "完成巡检",
    "confirmSwitch": "本次巡检尚未完成，确认是否切换地点？",
    "confirmSwitchBrand": "本次巡检尚未完成，确认是否切换公司？",
    "confirmSwitchInspect": "本次巡检尚未完成，确认是否切换巡检表？",
    ...
    "notBindCamera": "当前地点的巡检项未绑定设备！",
    "notCombined": "该地点暂未绑定巡检项！",
    "notableItem": "缺失项",
    "onsitePatrol": "现场巡检",
    ...
    "maximumTotalAttach_120": "全表最多允许上传 120 个附件",
    "maximumTotalAttach_500": "全表最多允许上传 500 个附件",
    "totalOf": "巡检报告共有",
    "numReports": "笔",
  ...
  "insSettingView": {
    ...
    "group": "大类",
    "hasBoundStoreNum": "{tableName}共有{allStoreNum}个地点，已绑定{boundStoreNum}个地点",
    ...
    "patrolExample": "地点标准-巡检表示例",
    "please": "请先",
    "prompt": "提 示",
    "rangeScoreTips": "考评总分最低值不得高于最高值",
    "relateAllStores": "绑定至所有地点",
    "relationDuty": "关联职务",
    "remarksType": "不参与评分",
    "remotePatrol": "远程巡检",
    "ruleInspect": "巡检规则设置",
    ...
    "selectPost": "请选择",
    "selectStore": "请选择",
    "selectStoreToBind": "请选择{tableName}巡检表，需要绑定的地点",
    "selecttitle": "请选择关联职务",
  ...
  "deviceView": {
    ...
    "licenseOverdue": "巡检服务已逾期",
    "mediaService": "流媒体服务",
    "mismatchInfo": "AppKey与Secret不匹配",
    "mobilePhone": "账号",
    "moreThanAuthorizedDevices": "账号关联设备数量超限",
    "multipleAccOnSameStore": "同一地点不允许绑定多个账号",
    "noAuthorityForStore": "对该地点无操作权限",
    "noData": "无数据",
    ...
    "selectPicture": "选择图片",
    "selectStore": "请选择所属地点",
    "selectStoreInfo": "地点选定后，不可编辑修改，请谨慎选择",
    "serialNum": "序列号",
    "serverIp": "服务器IP",
    "store": "所属地点",
    "storeNotExist": "地点不存在",
    "storeViuAccount": "iService账号",
    "storeViuNum": "个iService账号，",
    "submit": "提交",
  ...
  "scheduleView": {
    ...
    "bindAllStore": "关联至所有地点",
    "bindStore": "绑定地点",
    "cancel": "取消",
    "city": "城市",
    "confirm": "确认",
    "confirmBind": "套用排程会覆盖至关联地点，确认绑定？",
    "daily": "日模式",
    "date": "日期",
    "days": "天",
    "delete": "删除",
  ...
  "statistics": {
    ...
    "patrolPerson": {
      ...
      "numOfStores": "管辖地点（个）",
      "numOfTotal": "巡检次数（次）",
      "numOfStoresNotPatrolled": "未巡检地点（个）",
      "numOfTasked": "巡店排程任务",
    ...
    "event": {
      ...
      "UnqualifiedpPercentage": "不合格占比",
      "numOfStores": "涉及地点",
      "seeAllIncepEvent": "查看所有巡检事件",
      "seeAll": "全部",
      "eventInvolveStores": "事件涉及地点",
  ...
  "audit": {
    "auditStatus": {
      ...
      "open": "開啟",
      "autoApprove": "自动签核",
      "autoApproveDays": "自动签核天数",
      "most7Days": "自动签核天数最多为七天。",
    },
    "sendAudit": {
      "all": "全部",
      "processing": "进行中",
  ...
  "schedule": {
    ...
    "scheduleSetting": "排程设定",
    "scheduleHistory": "排程纪录",
    "scheduleExecuted": "排程执行",
    "lastUpdatePerson": "最后更新人",
    "getScheduleSettingFail": "取得排程设定失败",
    "schStartDate": "开始执行",
    "schName": "排程名称",
    "incepNum": "巡检数量",
    "schEndDate": "最后执行",
    ...
    "tagInfo": "巡检类型 | 巡检表名称",
    "deleteSchedule": "删除排程",
    "confirmDeleteSchedule": "是否需要删除已选择的排程？",
    "store": "地点/时区",
    "schExeDate": "執行日期",
    "reportUploadDate": "报告上传时间",
    "incepPerson": "执行日期",
    "inCompleted": "未完成",
    "exportAll": "全部汇出",
    "isProcessing": "簽核中",
    ...
    "inceptionMode": "巡检类型",
    "generated": "已产生",
    "exportScheduleRecordTips": "汇出排程纪录提示",
    "exportScheduleRecordMsg1": "排程纪录汇出执行中，汇出完成将自动下载档案",
    "exportScheduleRecordMsg2": "于执行时间您仍可继续操作系统功能",
    "exportScheduleRecordWarn": "请选择汇出项目",
    "deletePersonSchError": "个人排程删除失败",
    "deleted": "已删除",
    "save": "储存",
    "basicInfo": "基本讯息",
    ...
    "noData": "暂无数据",
    "allStore": "全部地点",
    "pleaseFinished": "请完成执行日期设定",
    "remiderTime": "提醒时间 ",
    "pleaseFinishedTime": "请完成提醒时间设定",
    "remiderMethod": "提醒方式",
    "pleaseFinishedMethod": "请完成提醒方式设定",
    "reset": "重设",
    "instantly": "当下",
    "oneDayBefore": "前一日",
    "oneHourBefore": "前1小时",
    ...
    "selectStore": "选择地点",
    "hasSelected": "已选地点总数：",
    "ifDeleted": "是否需要删除已选择的地点？",
    "storeName": "地点 ",
  },
  "generalSetting": {
    "save": "保存",
    "timeoutReminder": "超时提醒",
    "eventTimeoutReminder": "事件超时提醒",
    "moreThanDays": "超过天数",
    "daysOfStay": "停留天数",
    "reminderTime": "提醒时间",
    "signatureTimeoutReminder": "签核超时提醒",
    "reports": "巡检报告",
    "reportViewPermissions": "报表检视权限",
    "viewReportbyFormExecutionPermissions": "依表单执行权限检视报告",
    "viewReportsByStorePermissions": "依门店权限检视报告 ",
  },
  "immediatePush": {
    "broadcast": "公告讯息",
    "sendBroadcast": "发送公告",
    ...
    "position": "职务",
    "selectPosition": "请选择职务",
    "specificObject": "特定对象",
    "staff": "人员",
    "selectStaff": "请选择人员",
    "numberOfSenders": "发送人员数量：",
    "message": "发送讯息",
    "messageTitle": "标题",
    "inputMessageTitle": "请输入标题标题",
    "maxInput": "最多可输入",
    "character": "个字元",
    "messageContent": "内容",
    "attachment": "附件",
  ...
  "downloadManagement": {
    ...
    "clearAll": "全部清空",
    "conformDel": "确认删除",
    "deleteThisItem": "请确认是否删除此项目",
    "deleteAllItem": "是否确认清空下载列表",
    "condition": "条件",
    "fileName": "档案名称",
    "statusShowing": "状态",
    "ts": "汇出时间",
    "all": "全部",
    "inspectReport": "巡店管理-巡检报告",
    "eventMgn": "事件管理",
    "patrolEvaluation": "统计分析-巡店考评统计",
    "patrolItem": "统计分析-巡检项统计",
    "patrolPersonStat": "统计分析-巡检人员统计",
    "eventStat": "统计分析-事件处理统计",
    "scheduleHistory": "巡检排程-排程纪录",
    "requestType_1001": "报告完整汇出",
    "requestType_1002": "报告明细汇出",
    "requestType_1003": "报告详情 - Excel汇出",
    "requestType_2001": "未处理事件",
    "requestType_2002": "已处理事件",
    "requestType_2003": "已结案事件",
    "requestType_2004": "退回事件",
    "requestType_2005": "全部事件",
    "requestType_3001": "考评结果分布",
    "requestType_3002": "考评得分分布",
    "requestType_3003": "考评达标率",
    "requestType_4001": "评估详情",
    "requestType_5001": "巡检人员统计列表",
    "requestType_5002": "巡检详情",
    "requestType_5003": "已送出事件结案率",
    "requestType_6001": "门店事件",
    "requestType_6002": "事件占比",
    "requestType_6003": "事件涉及门店",
    "requestType_7001": "排程纪录 汇出Excel",
    "timeRange": "时间范围: ",
    "inSpection": "巡检表: ",
    "store": "门店: ",
    "fail": "失败",
    ...
    "done": "完成",
    "expired": "已失效",
    "fileExpired": "档案已过期，请重新汇出",
    "dayExpired": "下载连结于3天后失效，请即时下载",
  },

  "advance": {
    "waterMarkSetting": "浮水印设定",
    "on": "开启",
    "off": "关闭",
    "showMarkSetting": "浮水印显示",
    "opiton": "请选择",
    "maxCharacter": "最多可输入 32 个字元",
    "textColor": "文字颜色",
    "textSize": "文字大小",
    "textPOsition": "浮水印位置",
    "userName": "人员名称",
  ...
  "reportAndEvents": {
    "reportType": "报表类型",
    "inceptionTag": "巡检表",
    "modifyClosedEvents": "修改已结案事件",
    "changeStatus": "请确认是否变更状态为",
    "unprocessed": "未处理",
  },
  "createinspect": {
    "save": "储存",
    ...
    "formType": "表单类型",
    "otherSettings": "其他设定",
    "ignoredItems": "忽略项视同得分",
    "SignFirst": "先签到，再巡检",
    "ShowAreaScoring": "显示区域计分(仅支援网页版)",
    "categoryScoring": "显示巡检类别计分",
    "permissionSettings": "权限设定",
    "PositionAuthority": "职务权限",
    "bindAllLocations": "绑定至所有地点",
    "PassRateScoringItems": "合格率評分項",
    "ScoringItems": "合格率評分項",
    "additionalRatingItems": "附加评分项",
    "secondLevelForm": "二阶层表单",
    "threeLevelForm": "三阶层表单",
    "noRepeat": "巡检表名称名称不可重复",
    "startScoreNoEmpty": "扣分起始分数不可为空",
    "hiNoEmpty": "考评总分范围最低分数不可为空",
    "lowNoEmpty": "考评总分范围最高分数不可为空",
  },
  "deleteReport": {
    "confirmDelete": "是否确认删除报告",
    "notice_1": "请注意！删除报告后资料无法复原，请确保您要删除的报告是正确的，请谨慎操作。 为确保报告的安全删除，请提供用户密码并勾选 ",
    "notice_2": "「我理解并同意删除报告」",
    "notice_3": "如果您有任何疑问或需要协助，请随时联络我们的客服团队。",
