    ...
    methods: {
      ...
      onMessageWasSent (message) {
        ...
        const params = {
          "inputs": {
              "text": "給我七月事件",
              "token": "app-EOwXvP3uLGKxlHgBCRBWXmdO",
        ...
        //   // this.messageList = [ ...this.messageList, res.data.text ]
        // })
        // .catch((error) => {
        //   console.error(error)
        // })
      ...
      openChat () {
        ...
        // const genieaiApi = 'https://app.genieai.wise-paas.com.cn/api/workflows/run'
        // const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.._7xMoVgUNbjVmgoHecT-EZNLvQHXSfrrf67vxBra1rY'
        // axios.post(genieaiApi, params , {
        //   headers: {
        //     'Authorization': `Bearer ${token}`,
